...
-- phase_predictions: lo que pronostico cada uno en una fase, pero solo
-- cuando ya esta cerrada. La comprobacion vive en el servidor porque la
-- clave publica permite llamar a esta funcion desde el navegador.
