-- =====================================================================
-- 003 — El bote en la clasificación
-- =====================================================================
-- Ejecutar en: Supabase Dashboard → SQL Editor → New query → Run
--
-- La clasificación enseñaba "Pagados: N" al participante, que es un dato de
-- gestión y a él no le dice nada. En su lugar va el bote, que sí anima.
--
-- Para calcularlo hace falta cuánta gente cuenta, y no sirve el tamaño de la
-- clasificación: ahí solo aparece quien ya tiene alguna fase contabilizada,
-- así que al empezar el torneo daría menos de los que son y el bote se vería
-- más pequeño de lo que es.
--
-- Unico cambio respecto a la version anterior: boot() devuelve paid_count.
-- =====================================================================
