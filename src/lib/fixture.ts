...
const knockoutPhases: KnockoutPhase[] = [
  ...
  knockout('R16', 'Octavos', '4 – 7 jul', [
    ['R16-1', 'Gan. 16avos 2', 'Gan. 16avos 7'],
    ['R16-2', 'Gan. 16avos 8', 'Gan. 16avos 4'],
    ['R16-3', 'Gan. 16avos 12', 'Gan. 16avos 6'],
    ['R16-4', 'Gan. 16avos 1', 'Gan. 16avos 16'],
    ['R16-5', 'Gan. 16avos 5', 'Gan. 16avos 9'],
    ['R16-6', 'Gan. 16avos 14', 'Gan. 16avos 11'],
    ['R16-7', 'Gan. 16avos 3', 'Gan. 16avos 13'],
    ['R16-8', 'Gan. 16avos 15', 'Gan. 16avos 10'],
  ]),
