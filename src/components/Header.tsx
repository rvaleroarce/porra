 ...
 *
 * La franja del final es lo único que queda del degradado de antes: mantiene
 * la firma de la app sin volver a apoderarse de la pantalla, y hace de línea
 * divisoria con el contenido.
 */
  ...
  return (
    <header className="w-full bg-card">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, rgb(var(--accent)) 0%, rgb(var(--accent2)) 100%)',
        }}
      />
    </header>
  );
